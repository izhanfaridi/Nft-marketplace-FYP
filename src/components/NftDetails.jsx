    ...
    <>
      ...
      <div className="gradient-css-div-details h-screen">
        ...
        <div className="flex justify-evenly items-start">
          <div className="w-96 ring ring-1 ring-black rounded-md flex flex-col justify-center items-end">
            <img
          ...
          <div className="flex-col  w-8/12    	">
            <div className="ring ring-1 ring-black rounded-t-md px-4 py-2 details-div w-full">
              <p className="text-md font-medium text-gray-500">{nft.creator}</p>
              <p className="py-5 text-4xl font-bold">{nft.title}</p>
            </div>
            <div className="rounded-b-md ring ring-1 ring-black px-4 py-2 details-div w-full">
